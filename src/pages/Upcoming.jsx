...
const Upcoming = ({tmdb}) => {
    ...
    // load movies
    useEffect(() => {
        queryResults(`${tmdb.baseUrl}/${type}/upcoming?page=${currentPage}`, tmdb, results, setResults, setPages, setResultsCount);
    }, [currentPage]);
    ...
    return (
        <div> 
            ...
            <div className='container mx-auto max-w-7xl px-10'>
                <ResultsHeader className = "text-white font-bold text-lg" text={`Upcoming`} resultsCount = {resultsCount} setType={setType} />
