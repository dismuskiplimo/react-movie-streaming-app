...
const Popular = ({tmdb}) => {
    ...
    // load movies
    useEffect(() => {
        queryResults(`${tmdb.baseUrl}/${type}/popular?page=${currentPage}`, tmdb, results, setResults, setPages, setResultsCount);
    }, [currentPage]);
    ...
    return (
        <div> 
            ...
            <div className='container mx-auto max-w-7xl px-10'>
                <ResultsHeader className = "text-white font-bold text-lg" text={`Popular`} resultsCount = {resultsCount} setType={setType} />
